...
# Layout
app.layout = html.Div([
    html.H1("🎥 Movie Industry Box Office Analysis", style={'textAlign': 'center', 'color': 'gold', 'backgroundColor': 'black', 'padding': '10px', 'margin': '0'}),
    
    dcc.Tabs(id='tabs', value='tab1', style={'backgroundColor': 'black'}, children=[
    dcc.Tab(label='📈 Genre Trends Over Time', value='tab1', style={'backgroundColor': 'black', 'color': 'gold'}),
    dcc.Tab(label='📊 Total Genre Revenue Comparison', value='tab2', style={'backgroundColor': 'black', 'color': 'gold'}),
    dcc.Tab(label='📊 Yearly Genre Comparison', value='tab3', style={'backgroundColor': 'black', 'color': 'gold'})
]),
    ...
    html.Div([
        ...
        html.Div([
            dcc.RangeSlider(
                ...
                marks={i: {'label': str(i), 'style': {'color': 'white'}} for i in range(genre_trends['Release Year'].min(), genre_trends['Release Year'].max()+1, 5)},
                tooltip={'always_visible': True, 'placement': 'bottom'},
    )
], style={'backgroundColor': 'black', 'padding': '10px'}),

        html.H3(id="summary-title", style={'color': 'gold', 'backgroundColor': 'black', 'padding': '5px', 'margin': '0'}),  
        ...
        html.Div([
            ...
            html.H3(id="yearly-summary-title", style={'color': 'gold', 'backgroundColor': 'black', 'padding': '5px', 'margin': '0'}),  
            dash_table.DataTable(
...
# Callback to summary table (over time)
@app.callback(
...
# Callback to summary table (yearly)
@app.callback(
...
if __name__ == '__main__':
    app.run_server(host="0.0.0.0", debug=True, port=8054)
